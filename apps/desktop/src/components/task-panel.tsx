...
import { IconClock, IconPlus, IconChevronRight } from "./icons";

export function TaskPanel() {
  return (
    <aside className="flex h-full w-[272px] shrink-0 flex-col border-l border-border-subtle bg-bg-deep">
      {/* Header */}
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6">
        ...
        <p className="mt-1 text-center text-[11px] leading-relaxed text-text-ghost">
